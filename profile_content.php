    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="header">
                        <h4 class="title" style = "color: #DC006C;"><b>Edite o seu perfil</b></h4>
                    </div>
                    <div class="content">
            ...
            <div class="col-md-3">
                <div class="card card-user" style = "top: 0;">
                    ...
                    <a href="<?php echo $result[0]["facebook"]; ?>"><i class="fa fa-facebook"></i></a>
                    <a href="<?php echo $result[0]["instagram"]; ?>"><i class="fa fa-instagram"></i></a>
                    <a href="<?php echo $result[0]["skype"]; ?>"><i class="fa fa-skype"></i></a>
