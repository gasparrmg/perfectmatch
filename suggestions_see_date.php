                 ...
                 <div class="content">
                      <div class="row">
                         <div class="col-md-2"></div>
                          <?php
                            if($idperfillogado === $idperfil1){
                                
                                echo '<div class="col-md-4"><div class="card card-user" style = "top: 0;"><br>';
                                    echo '<img class ="avatar" src = "avatars/'.$perfil1[0]["avatar"].'"><br><br>';
                                    echo '<h2 class="title">'.$perfil1[0]["primeiro_nome"].' '.$perfil1[0]["ultimo_nome"].'</h2>';
                                ...
                                echo '</div></div><div class="col-md-4"><div class="card card-user" style = "top: 0;"><br>';    
                                    echo '<img class ="avatar" src = "avatars/'.$perfil2[0]["avatar"].'"><br><br>';
                                    echo '<h2 class="title"><a class=dates_see_profile id="'.$idperfil2.'" href = "" value = "dates_see_profile.php">'.$perfil2[0]["primeiro_nome"].' '.$perfil2[0]["ultimo_nome"].'</a></h2>';
                                ...
                                echo '<div class="col-md-4"><div class="card card-user" style = "top: 0;"><br>';
                                    echo '<img class ="avatar" src = "avatars/'.$perfil1[0]["avatar"].'"><br><br>';
                                    echo '<h2 class="title"><a class=dates_see_profile id="'.$idperfil1.'" href = "" value = "dates_see_profile.php">'.$perfil1[0]["primeiro_nome"].' '.$perfil1[0]["ultimo_nome"].'</a></h2>';
                                    echo '<p class="category">'.$perfil1[0]["descrição"].'</p>';
                                    echo '<a href="#"><i class="fa fa-instagram"></i></a>';
                                    echo '<a href="#"><i class="fa fa-facebook"></i></a>';
                                    echo '<a href="#"><i class="fa fa-skype"></i></a>';
                                echo '</div></div><div class="col-md-4"><div class="card card-user" style = "top: 0;"><br>';    
                                    echo '<img class ="avatar" src = "avatars/'.$perfil2[0]["avatar"].'"><br><br>';
                                    echo '<h2 class="title">'.$perfil2[0]["primeiro_nome"].' '.$perfil2[0]["ultimo_nome"].'</h2>';
                                    echo '<p class="category">'.$perfil2[0]["descrição"].'</p>';
                                    echo '<a href="#"><i class="fa fa-instagram"></i></a>';
                                    echo '<a href="#"><i class="fa fa-facebook"></i></a>';
                                    echo '<a href="#"><i class="fa fa-skype"></i></a>';
